...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://engine-dashboard-1.preview.emergentagent.com').rstrip('/')
    ...
    def test_checkout_creates_session_starter(self, authenticated_client):
        ...
        response = authenticated_client.post(
            ...
            json={
                ...
                "origin_url": "https://engine-dashboard-1.preview.emergentagent.com"
            }
        )
        assert response.status_code == 200
