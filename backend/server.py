...
async def startup_db():
    ...
    global stripe_service, feature_gating, elite_service, arris_memory_service, arris_historical_service, calculator_service, export_service, pattern_engine, smart_automation_engine, proposal_recommendation_service, enhanced_memory_palace, onboarding_wizard, auto_approval_service, referral_service, persona_service, scheduled_reports_service
