...
# ============== AUTHENTICATION ==============
# NOTE: Auth routes are now handled by routes/auth.py module
# The following endpoints are managed by auth_router:
# - POST /auth/register
# - POST /auth/login  
# - GET /auth/me
# - GET /auth/verify
# - GET /creators/form-options
...
# NOTE: /creators/me, /creators/me/proposals, /creators/me/dashboard routes
# migrated to /app/backend/routes/creator_dashboard.py
...
# NOTE: Referral routes migrated to /app/backend/routes/referral.py
...
# NOTE: Pattern export routes are now handled by routes/creator.py module
# The following endpoints are managed by creator_routes_router:
# - GET /creators/me/pattern-export/options
# - GET /creators/me/pattern-export/preview
# - POST /creators/me/pattern-export
# - GET /creators/me/pattern-export/history

# ============== PREDICTIVE ALERTS ENDPOINTS (Pro+) ==============
# NOTE: Core alerts routes are now handled by routes/creator.py module
# The following endpoints are managed by creator_routes_router:
# - GET /creators/me/alerts
# - POST /creators/me/alerts/{alert_id}/read
# - POST /creators/me/alerts/{alert_id}/action

# Additional predictive alert endpoints (not in modular routes):
...
# NOTE: All escalation routes are now handled by routes/admin.py module
# The following endpoints are managed by admin_routes_router:
# - GET /admin/escalation/dashboard
# - GET /admin/escalation/stalled
# - GET /admin/escalation/history
# - GET /admin/escalation/analytics
# - POST /admin/escalation/check/{proposal_id}
# - POST /admin/escalation/escalate/{proposal_id}
# - POST /admin/escalation/resolve/{escalation_id}
# - POST /admin/escalation/scan
# - GET /admin/escalation/config
# - PUT /admin/escalation/config
...
# NOTE: Elite workflows and brands routes migrated to /app/backend/routes/elite.py

# NOTE: Elite dashboard, adaptive-intelligence, and status routes migrated to /app/backend/routes/elite.py


# NOTE: Elite personas and reports routes migrated to /app/backend/routes/elite.py


# NOTE: Elite ARRIS API endpoints migrated to /app/backend/routes/elite.py

# NOTE: Elite multi-brand and contact/inquiries routes migrated to /app/backend/routes/elite.py

# NOTE: ARRIS memory, patterns, learning, activity routes migrated to /app/backend/routes/arris.py
...
# NOTE: /creators/me must be defined BEFORE /creators/{creator_id} to avoid route conflict
...
# NOTE: Project Proposals routes migrated to /app/backend/routes/proposals.py
...
# NOTE: ARRIS activity feed, queue position, live stats, recent activity, and learning routes
# migrated to /app/backend/routes/arris.py
...
# NOTE: /proposals/stats/summary route migrated to /app/backend/routes/proposals.py
...
# NOTE: 17_SUBSCRIPTIONS CRUD routes migrated to /app/backend/routes/subscriptions.py
...
# NOTE: Proposal Recommendations routes migrated to /app/backend/routes/proposals.py
...
api_router.include_router(arris_routes_router)
